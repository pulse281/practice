...
const employersNames = employers.filter(employer => employer).map(name => name.toLowerCase().trim());
...
function makeBusiness({emp,  cash, owner = 'Sam', director = 'Victor'}) {
...
makeBusiness({emp: employersNames, cash: money});